			...
			<div class="card-body">
				...
				<div class="col-sm-6">
					...
					<h5 class="card-title">Campos com <span class="text-danger">*</span> são obrigatorios!</h5>
						...
						<input type="hidden" name="id" value="<?php echo $tipoimposto['id'];?>">
						<div class="form-group">

							<label>Nome do Tipo<span class="text-danger">*</span></label>

							<input type="text" name="nometipo" id="nometipo" class="form-control" placeholder="Nome do Produto" value="<?php echo $tipoimposto['nometipo'];?>" required>
						...
						<div class="form-group">
							...
							<input type="number" step="0.01" name="porcentagem" id="porcentagem" class="form-control" placeholder="Porcentagem do tipo" value="<?php echo $tipoimposto['porcentagemimposto'];?>" required>
